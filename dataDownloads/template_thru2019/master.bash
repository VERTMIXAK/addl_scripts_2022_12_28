...
#echo $year
yearMinus1=`echo " $year - 1 " | bc`


echo $yearMinus1 $year


grep $yearMinus1- /import/VERTMIXFS/jgpender/roms-kate_svn/addl_Scripts/dayConverterCommas.txt | tail -1 > dates.txt
