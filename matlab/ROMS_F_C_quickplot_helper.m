...
[~,hc]=m_contourf(C.lon,C.lat,C.ta_C_lin,[-1:.001:-.001 .001:.001:1]);hold on
set(hc,'linestyle','none')
m_contour(F.lon,F.lat,F.H,16,'color',[1 1 1]*.5);hold on;caxis([-1,1]/10)
...
m_coast('patch',[.5 1 0])
title([roms.exp1],'interpreter','none')
%colorbar
