...
roms.files.C_hp_file   = [roms.analysis_path,'roms_C_hp_m_',roms.latlonRange,'.mat'];
roms.files.hpcfile     = [roms.analysis_path,'roms_hp_c_m_',roms.latlonRange,'.mat'];
roms.files.hpubtfile   = [roms.analysis_path,'hp_ubt_',roms.latlonRange,'.nc'];
roms.files.hpvbtfile   = [roms.analysis_path,'hp_vbt_',roms.latlonRange,'.nc'];
his_file               = roms.files.his_hourly_files{1};slashes = findstr(his_file,'/');
roms.files.psi_file    = [roms.analysis_path,'psi_',roms.latlonRange,'.mat']
%%
%keyboard 
%%
